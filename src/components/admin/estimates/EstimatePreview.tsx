...
export function EstimatePreview({ data }: { data: EstimatePreviewData }) {
  return (
    <div className="bg-white border border-[var(--border-light)] rounded-lg shadow-sm w-full max-w-[650px] mx-auto text-sm">
      ...
      <div className="px-4 sm:px-8 py-3 sm:py-4 border-b border-[var(--border-light)] grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
        ...
        <div className="sm:text-right space-y-2">
          <div>
            <p className="text-xs text-[var(--text-muted)]">Estimate Date:</p>
          ...
          {data.validUntil && (
            <div>
              <p className="text-xs text-[var(--text-muted)]">Valid Until:</p>
              <p className="font-medium text-[var(--text-primary)]">
      ...
      <div className="px-4 sm:px-8 py-3 sm:py-4 text-center rounded-b-lg bg-[var(--neutral-lightest-gray)]">
        <p className="text-[10px] sm:text-xs text-[var(--text-secondary)] mb-1">
          This is an estimate and not a final invoice. Prices may vary based on actual work performed.
        </p>
